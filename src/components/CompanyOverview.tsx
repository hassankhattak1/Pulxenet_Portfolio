    ...
    <section id="about" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h3 className="font-bebas text-4xl md:text-6xl text-heading mb-6 tracking-wide">Bridging the Gap with Offshore Delivery</h3>
          <p className="text-lg text-paragraph">
            Pulxenet specializes in providing top-tier Managed IT Services and Custom Development for GCC clients. We leverage an advanced offshore delivery model to bring high-quality technical talent to your projects while optimizing operational costs.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feat, idx) => (
            <div key={idx} className="glass-card p-6 rounded-2xl border border-gray-100 hover:border-primary/30 transition-all group hover:shadow-lg hover:-translate-y-1">
